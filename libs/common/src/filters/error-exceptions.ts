...
export class ForbiddenErrorException extends ForbiddenException {
  constructor(message = 'You are not authorized to perform this action', error = undefined) {
    super({
      status: 'error',
      message,
      data: error,
...
export class NotFoundErrorException extends NotFoundException {
  constructor(message = 'The requested resource could not be found ', error = undefined) {
    super({
      status: 'error',
      message,
      data: error,
